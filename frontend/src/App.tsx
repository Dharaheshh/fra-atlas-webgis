    ...
    return (
        <div className="h-screen w-full flex flex-col bg-slate-50 overflow-hidden relative">
            <header className="bg-emerald-800 text-white p-4 shadow-md z-[1001] flex justify-between items-center relative shrink-0">
                ...
                <div className="flex items-center gap-4">
                    <button
                        ...
                        className="hidden sm:flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white px-4 py-1.5 rounded-lg border border-indigo-400 font-semibold shadow-sm transition-all text-sm animate-pulse focus:animate-none"
                    >
                        <Layers className="w-4 h-4" /> Simulate phase 5
                    </button>
            ...
            <main className="flex-1 flex w-full relative h-[calc(100vh-76px)] overflow-hidden">
                ...
                {/* Phase 5 Isloated Simulation Overlay */}
